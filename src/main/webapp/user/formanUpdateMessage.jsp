...
<body>
	<div style="background-color: #AFEEEE;height: 130px;">
			<a style="margin-right: 0px;white-space: normal;display: inline-block;" href="<%=request.getContextPath() %>/user/formanLogin.jsp"><h2>工头中心</h2></a><h3 style="margin-right: 0px;white-space: normal;display: inline-block;">/设置我的信息</h3>
			<hr>
	</div>
	<br><br><br>
	<div style="margin-left: 45%;">
		<form method="post" id="updateCheck" action="<%=request.getContextPath()%>/user/foremanLogin.jsp">
				<c:forEach items="${userList}" var="user">
					...
					角色名称:&nbsp;<input style="margin-right: 40px; border: 0px;" type="text" id="rolename" name="rolename" value="${user.rolename}"readonly="readonly"/><br><br>
					家庭住址:&nbsp;<input style="margin-right: 40px; border: 0px;" type="text" id="adress" name="adress" value="${user.adress}"/>
					身份证号:&nbsp;<input style="margin-right: 40px; border: 0px;" type="text" id="idcard" name="idcard" value="${user.idcard}"/><br><br>
