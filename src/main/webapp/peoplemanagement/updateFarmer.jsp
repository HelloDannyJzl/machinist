...
<body>
	<div style="background-color: #AFEEEE;height: 130px;">
			<a style="margin-right: 0px;white-space: normal;display: inline-block;" href="<%=request.getContextPath() %>/manage/queryAllUser.do"><h2>用户中心</h2></a><h3 style="margin-right: 0px;white-space: normal;display: inline-block;">/农户详情</h3>
			<hr>
	</div>
	<br><br><br>
	<div style="margin-left: 45%;">
		<form method="post" id="updateCheck" action="<%=request.getContextPath()%>/manage/updateUser.do">
				<c:forEach items="${userList}" var="user">
					...
					员工密码:&nbsp;<input style="margin-right: 40px; border: 0px;" type="text" id="adress" name="adress" value="${user.password}"/><br><br>
					...
					<input style= "height:25px;width:90px; background-color: #FFE4B5 ;" type="button"  value="返回" onclick="black()"/>&nbsp;
